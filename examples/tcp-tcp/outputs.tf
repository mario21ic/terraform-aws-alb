...
output "target_group_http_arns" {
  ...
  value       = "${module.lb-tcp-tcp.target_group_http_arns}"
}
...
output "target_group_https_arns" {
  ...
  value       = "${module.lb-tcp-tcp.target_group_https_arns}"
}
...
output "principal_account_id" {
  ...
  value       = "${module.lb-tcp-tcp.principal_account_id}"
}
